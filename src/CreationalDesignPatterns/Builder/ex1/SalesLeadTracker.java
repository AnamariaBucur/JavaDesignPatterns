package CreationalDesignPatterns.Builder.ex1;

import CreationalDesignPatterns.Builder.ex1.Person;
...
public class SalesLeadTracker {
    public static void main(String[] args) {
        var person1 = new Person.PersonBuilder("Tracy","Westbay")
                ...
                .build();
//        var person1 = new Person("Tracy", null,"Westbay", LocalDate.of(1985,1,1),"tracy@example.com",null);
        ...
        var person2 = new Person.PersonBuilder("Jerome","Donaldson")
                ...
                .build();
//        var person2 = new Person("Jerome","Henry","Donaldson",null,null,"123456789");
